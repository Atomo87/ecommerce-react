...
class UsuarioController {
    ...
    completeRecovery(req, res, next){
        ...
        if(!token || !password || !repassword) return res.render("recovery/store", { error: "Preencha novamente com sua nova senha", success: null, token: token });
       if(password !== repassword) return res.render("recovery/store", { error: "As senhas conferem,tente novamente!", success: null, token: token });
